...
# The 10 specific reviews the user wants to keep
REVIEWS = [
...
def cleanup():
    print(f"Resetting and Seeding {len(REVIEWS)} reviews to {PROD}/api/reviews/reset-and-seed...")
    try:
        resp = requests.post(
            f"{PROD}/api/reviews/reset-and-seed",
            json=REVIEWS,
