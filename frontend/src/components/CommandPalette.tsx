...
export function CommandPalette() {
  ...
  const COMMANDS: CommandItem[] = [
    ...
    { id: "code", label: "DSA & Coding Lab", description: "Practice Data Structures", icon: <Code size={18} />, color: "#10B981", action: () => navigate("/dashboard/code"), keywords: ["dsa", "algorithm", "leetcode", "problem"] },
